...
raw_data_ao <- raw_data[,filter] # grab samples that are astro and oligo
...
raw_data_ao <- raw_data_ao[,filter] # grab samples that are grade 2 or grade 3
...
ggplot(dataGG_ao, aes(PC1, PC2)) +
 ...
 scale_color_manual(values = c("darkorange2", "dodgerblue4")) # Figure 1


oligo::boxplot(raw_data_ao, target = "core",
              main = "Boxplot of log2-intensitites for the raw data (astrocytoma and oligodendroglioma) ") # Figure 6
...
ggplot(dataGG_aon, aes(PC1, PC2)) +
 ...
 theme(plot.title = element_text(hjust = 0.5))+
 scale_shape_manual(values = c(4,15)) +
 scale_color_manual(values = c("antiquewhite4", "blueviolet", "chartreuse")) # Figure 2

oligo::boxplot(raw_data_aon, target = "core",
              main = "Boxplot of log2-intensitites for the raw data (astrocytoma, oligodendroglioma, and normal) ") # Figure 7
...
ggplot(dataGG_an, aes(PC1, PC2)) +
 ...
 theme(plot.title = element_text(hjust = 0.5))+
 scale_shape_manual(values = c(4,15)) +
 scale_color_manual(values = c("antiquewhite4", "blueviolet")) # Figure 3


oligo::boxplot(raw_data_aon, target = "core",
              main = "Boxplot of log2-intensitites for the raw data (astrocytoma and normal) ") # Figure 8
